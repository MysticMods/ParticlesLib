...
public class ModParticles {
  ...
  public static RegistryEntry<GlitterParticleType> GLITTER_PARTICLE = REGISTRATE.simple("glitter_particle", ParticleType.class, GlitterParticleType::new);
  ...
  public static RegistryEntry<SparkParticleType> SPARK_PARTICLE = REGISTRATE.simple("spark_particle", ParticleType.class, SparkParticleType::new);
