...
public class FieryParticle extends GenericParticle {
  public FieryParticle(ClientLevel world, GenericParticleData data, double x, double y, double z, double vx, double vy, double vz) {
