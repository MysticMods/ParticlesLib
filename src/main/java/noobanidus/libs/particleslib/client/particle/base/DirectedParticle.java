...
public class DirectedParticle extends TextureSheetParticle {
  ...
  public DirectedParticle(ClientLevel world, DirectedParticleData data, double x, double y, double z, double vx, double vy, double vz) {
    this(world, data, x, y, z, vx, vy, vz, SpriteParticleRenderType.INSTANCE, RenderUtil.DELAYED_PARTICLE);
  }

  protected DirectedParticle(ClientLevel world, DirectedParticleData data, double x, double y, double z, double vx, double vy, double vz, ParticleRenderType renderer, RenderType type) {
