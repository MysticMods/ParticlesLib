...
public class MoteParticle extends GenericParticle {
  public MoteParticle(ClientLevel world, GenericParticleData data, double x, double y, double z, double vx, double vy, double vz) {
