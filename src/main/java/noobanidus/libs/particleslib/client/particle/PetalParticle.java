...
public class PetalParticle extends GenericParticle {
  public PetalParticle(ClientLevel world, GenericParticleData data, double x, double y, double z, double vx, double vy, double vz) {
