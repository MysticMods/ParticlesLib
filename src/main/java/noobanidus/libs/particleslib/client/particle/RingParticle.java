...
public class RingParticle extends GenericParticle {
  public RingParticle(ClientWorld world, GenericParticleData data, double x, double y, double z, double vx, double vy, double vz) {
