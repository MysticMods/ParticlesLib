...
public class FeyLightParticle extends GenericParticle {
  public FeyLightParticle(ClientLevel world, GenericParticleData data, double x, double y, double z, double vx, double vy, double vz) {
