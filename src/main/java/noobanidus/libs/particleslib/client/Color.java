package noobanidus.libs.particleslib.client;

import com.google.common.base.Objects;
import noobanidus.libs.particleslib.StatUtils;

/*
This class taken from and adapted from Color from the Mekanism project.
As the license of this project is also MIT, this is a license-compatible usage.
Original source: https://github.com/mekanism/Mekanism/blob/1.16.x/src/main/java/mekanism/common/lib/Color.java
 */
